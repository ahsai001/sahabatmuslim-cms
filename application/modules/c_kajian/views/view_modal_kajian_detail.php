      ...
      <div class="modal-content">
         ...
         <form id="form_kajian_detail" role="form">
            ...
            <div class="form-group">
               ...
               <input id="kajianStartEndtime" class="form-control"> 
            </div>

             <div class="form-group">
                  <label>Info</label>
                  <textarea id="kajianInfo" name="kajianInfo" class="form-control" rows="3"></textarea>
               </div>
            ...
            <div class="form-group">
               <label>User</label>
               <input id="kajianUser" class="form-control"> 
            </div>
            </form>
         </div>
