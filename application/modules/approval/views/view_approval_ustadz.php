   ...
   <body>
      <div id="wrapper">
         ...
         <div id="page-wrapper">
            <div class="row">
               <div class="col-lg-12">
                  <h1 class="page-header">Approval - Content Ustadz</h1>
                  <a id="link_list_ustadz" href="<?php echo $link_list_ustadz; ?>"></a>
                  <a id="link_action_ustadz" href="<?php echo $link_action_ustadz; ?>"></a>
               </div>
               <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
      ...
      <!-- App -->
      <script src="<?php echo $path_app; ?>js/approval_ustadz.js"></script>
   </body>
</html>
