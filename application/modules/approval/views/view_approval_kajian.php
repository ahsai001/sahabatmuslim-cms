   ...
   <body>
      <div id="wrapper">
         ...
         <div id="page-wrapper">
            <div class="row">
               <div class="col-lg-12">
                  <h1 class="page-header">Approval - Content Kajian</h1>
                  <a id="link_list_kajian" href="<?php echo $link_list_kajian; ?>"></a>
                  <a id="link_action_kajian" href="<?php echo $link_action_kajian; ?>"></a>
               </div>
               <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
      ...
      <!-- App -->
      <script src="<?php echo $path_app; ?>js/approval_kajian.js"></script>
   </body>
</html>