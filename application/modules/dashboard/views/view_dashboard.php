                     ...
                     <div class="panel-heading">
                        <div class="row">
                           ...
                           <div class="col-xs-9 text-right">
                              <div class="huge"><?php echo $num_rows_ustadz; ?></div>
                              <div>Ustadz</div>
                           </div>
                        </div>
                     </div>
                     <a href="<?php echo $link_page_ustadz; ?>">
                  ...
                  <div class="panel panel-green">
                     <div class="panel-heading">
                        <div class="row">
                           ...
                           <div class="col-xs-9 text-right">
                              <div class="huge"><?php echo $num_rows_kajian; ?></div>
                              <div>Kajian</div>
                           </div>
                        </div>
                     </div>
                     <a href="<?php echo $link_page_kajian; ?>">
                        <div class="panel-footer">
                           <span class="pull-left">View Details</span>
                           <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                           <div class="clearfix"></div>
                  ...
                  <div class="panel panel-yellow">
                     <div class="panel-heading">
                        <div class="row">
                           ...
                           <div class="col-xs-9 text-right">
                              <div class="huge"><?php echo $num_rows_lokasi; ?></div>
                              <div>Lokasi</div>
                           </div>
                        </div>
                     </div>
                     <a href="<?php echo $link_page_lokasi; ?>">
                        <div class="panel-footer">
                           <span class="pull-left">View Details</span>
                           <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                           <div class="clearfix"></div>
