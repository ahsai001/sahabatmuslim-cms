...
<body>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <a id="link_ustadz_refresh" href="<?php echo $link_ustadz_refresh; ?>"></a>

                    <a id="link_ustadz_create" href="<?php echo $link_ustadz_create; ?>"></a>

                    <a id="link_ustadz_update" href="<?php echo $link_ustadz_update; ?>"></a>
            ...
            <button id='btnCallModalUstadz' class="btn btn-primary">Add Ustadz</button><br/><br/>
    ...
    <script src="<?php echo $path_app; ?>js/ustadz.js"></script>
