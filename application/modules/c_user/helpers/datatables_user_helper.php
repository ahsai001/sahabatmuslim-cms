    ...
    function get_button_actions($id)
    {
        ...
        $html = '<div class="dropdown">
	  				...
	  				<ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
					   ...
					   <li><a href="' .base_url() . 'c_user/delete/' . $id .'">Delete</a></li>
					</ul>
				 </div>';
...
/* End of file datatables_user_helper.php */
/* Location: ./application/modules/c_user/helpers/datatables_user_helper.php */