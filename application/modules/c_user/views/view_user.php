...
<html lang="en">
   ...
   <body>
         ...
         <div id="page-wrapper">
            <div class="row">
               <div class="col-lg-12">
                  ...
                  <a id="link_user_refresh" href="<?php echo $link_user_refresh; ?>"></a>
                  <a id="link_user_create" href="<?php echo $link_user_create; ?>"></a>
                  <a id="link_user_update" href="<?php echo $link_user_update; ?>"></a>
               </div>
               <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <button id='btnCallModalUser' class="btn btn-primary">Add User</button><br/><br/>

            <!-- Modal User -->
            <?php echo $view_modal_user; ?>
      ...
      <!-- App -->
      <script src="<?php echo $path_app; ?>js/user.js?update=2018-09-27"></script>
   </body>
</html>