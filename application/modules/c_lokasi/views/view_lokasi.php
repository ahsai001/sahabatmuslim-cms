...
<html lang="en">
   ...
   <body>
         ...
         <div id="page-wrapper">
            <div class="row">
               <div class="col-lg-12">
                  ...
                  <a id="link_lokasi_refresh" href="<?php echo $link_lokasi_refresh; ?>"></a>
                  <a id="link_lokasi_create" href="<?php echo $link_lokasi_create; ?>"></a>
                  <a id="link_lokasi_update" href="<?php echo $link_lokasi_update; ?>"></a>
               </div>
               <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <!-- /.row -->
            <button id='btnCallModalLokasi' class="btn btn-primary">Add Lokasi</button><br/><br/>
      ...
      <!-- App -->
      <script src="<?php echo $path_app; ?>js/lokasi.js"></script>
   </body>
</html>